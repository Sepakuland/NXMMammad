...
import RKGrid, { FooterSome, CurrencyCell, TotalTitle,IndexCell,getLangDate,DateCell } from "rkgrid";
        ...
        <>
            <div style={{ backgroundColor: `${theme.palette.background.paper}` }} >
                <RKGrid
                    ...
                    showPrint={true}
                    excelFileName={t("حواله های موقت انبار")}
                    rowCount={10}
                    sortable={true}
                    pageable={true}
                    reorderable={true}
                    ...
                    <div className='row'>
                        <div className={'col-12 d-flex justify-content-end'}>
                            <Button variant="contained" style={i18n.dir()==='rtl'?{marginLeft:'10px'}:{marginRight:'10px'}}>
                                <Link to={`/WareHouse/Provisional/Remittance/Form`} >
                                    {t("جدید")}
                                </Link>
                            </Button >
...
export default TemporaryRemittance