    ...
    return (
      <td style={{ display: "flex" }}>
        {props.dataItem.Count.map((test, index) => {
          return (
            <div key={index} className="multipleUnits">
              {test}
            </div>
          );
        })}
        ...
        >
          <div className="row betweens">
            <div className="col-lg-3 col-md-3 col-3">
              {t("تاریخ سرجمع")}: 1401/10/10
            </div>
            <div className="col-lg-3 col-md-3 col-3">
              {t("تاریخ ارسال")}: 1401/10/10
            </div>
            <div className="col-lg-3 col-md-3 col-3">
              {t("مجموع حجم")}: 0 لیتر(dm3)
            </div>
            ...
            <div className="col-lg-3 col-md-3 col-3">
              {t("راننده")}:جهانگرد رضایی
            </div>
            <div className="col-lg-3 col-md-3 col-3">
              {t("خودرو")}: ایسوزو(شماره: 424ع18 ایران 29 مسی رنگ پرویزی)
            </div>
            <div className="col-lg-3 col-md-3 col-3">
              {t("پیش فاکتورها")}: 1014523، 1014519، 1014518، 1013435
            </div>
        ...
        <div className="p-3" style={{ direction: i18n.dir() }}>
          <div className="row justify-content-center">
            <div className="col-lg-11 col-md-12 col-sm-12 col-12">
              <p>
                {t(
                  "کلیه اقلام فوق، صحیح و سالم تحویل اینجانب ....................................................... گردید و پس از خروج از انبار حق هرگونه اعتراضی را از خود سلب می نمایم"
                )}
              </p>
            </div>
            ...
            <div className="col-lg-11 col-md-12 col-sm-12 col-12">
              <p>
                {t(
                  "به دلیل تأخیر حضور / غیبت / جابجایی راننده مربوطه ، کلیه اقلام مربوط به این حواله به آقای ....................................................... بعنوان تحویل گیرنده جایگزین ، تحویل و مسئولیت کلیه امور به عهده نامبرده می باشد"
                )}
              </p>
            </div>
            <div className="col-lg-11 col-md-12 col-sm-12 col-12 Signature">
...
export default PrintBatchTotalDesc;
