...
const TestBillWithNothing = ({ data }) => {
    ...
    const CustomFooterFee = (props) => <td className={'td-p0 border-left-0'} style={{ height: '72px' }}>
        <div>
            <div className='empty-footer-border'></div>
...
export default TestBillWithNothing