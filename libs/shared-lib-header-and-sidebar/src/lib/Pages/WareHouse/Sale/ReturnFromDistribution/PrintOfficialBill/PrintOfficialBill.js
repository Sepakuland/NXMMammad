...
import OfficialBillData from './OfficialBillData.json'
...
const OfficialBillPrint = () => {
    ...
    //////Copied From Warehouse/Sale/SemdCollection/DisplayDetails/Print/FormalPrint/FormalPrint.js (KTM)
    ...
    useEffect(() => {
        let tempData = OfficialBillData.map((data) => {
...
export default OfficialBillPrint
