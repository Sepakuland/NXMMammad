...
export const Send = () => {
    ...
    const callComponent = () => {
        history.navigate(
            `/WareHouse/sale/approvedInvoices`);
    };
    ...
    function addTempReceivedRow() {
        formik.setFieldValue("tempReceived", [...formik.values.tempReceived, emptyCash]);
    }
    function RenderTempOpenState(index, state) {
        if (index === tempFocusedRow - 1) {
            setTempCashOpen(state)
        }
        else {
            setTempCashOpen(false)
        }
    }
                    ...
                    <form onSubmit={formik.handleSubmit}>
                        <div className="form-design">
                            <div className="row ">
                                ...
                                <div style={{ width: "100px", marginRight: "33px" }} className={`${i18n.dir() == "ltr" ? "ltr" : "rtl"}`}>
                                    <Button
                                        style={{ width: "145px" }}
