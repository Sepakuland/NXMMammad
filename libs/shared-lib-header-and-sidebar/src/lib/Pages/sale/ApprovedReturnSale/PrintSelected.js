      ...
      >
        <div>
          ...
          <div
            className={`empty-footer ${i18n.dir()} justify-content-end word-break`}
          >
            {"9,810,000 [بدهکار]".toLocaleString()}
          </div>
          <div
            className={`empty-footer ${i18n.dir()} justify-content-end word-break`}
          >
      ...
      >
        <div className="row betweens">
          <div className="col-lg-4 col-md-4 col-4">
            {t("شماره فاکتور فروش")}:29
          </div>
          <div className="col-lg-4 col-md-4 col-4">
            {t("تاریخ فروش")}:1400/04/06
          </div>
          <div className="col-lg-4 col-md-4 col-4">{t("مبلغ فروش")}:9,810,000</div>
          <div className="col-lg-4 col-md-4 col-4">
            {t("کد طرف حساب")}:10001007
          </div>
          <div className="col-lg-4 col-md-4 col-4">
            {t("نام طرف حساب")}: شرکت سیمین سپهر سپاهان
          </div>
          <div className="col-lg-4 col-md-4 col-4">{t("ویزیتور")}:مدیر سیستم</div>
          <div className="col-lg-4 col-md-4 col-4">{t("دلیل برگشتی")}:معیوب بودن اجناس</div>
          <div className="col-lg-6 col-md-6 col-6">
            {t("توضیحات ")}:درج شده از طریق منوی نیازمندیهای فروش
          </div>
        </div>
      </Print>
