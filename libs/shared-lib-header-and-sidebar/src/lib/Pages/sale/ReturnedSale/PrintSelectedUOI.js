...
const PrintSelected = (props) => {
  ...
  const CustomFooterSome1 = (props) => {
    ...
    return (
      <td className={"td-p0 border-left-0"} style={{ height: "72px" }}>
        <div>
          <div
            className={` word-break empty-footer-border ${props?.className ? props?.className : ""
              }`}
            style={props.style}
          >
  ...
  const CustomTotalTitle = (props) => {
    return (
      ...
      >
        <div
          className={`empty-footer-border justify-content-start ${lang == "en" ? "border-right-1" : "border-left-1"
            }`}
        >
          {t("جمع")}
        </div>
        <div
          className={`empty-footer justify-content-start ${lang == "en" ? "border-right-0" : "border-left-0"
            }`}
        >
          {t("")}
        </div>
        <div
          className={`empty-footer ${lang == "en" ? "border-right-0" : "border-left-0"
            }`}
        >
          {" "}
        </div>
  ...
  return (
    <>
      <Print
        ...
        subTitle={t("برگشت از فروش")}
      >
        <div className="row betweens">
          <div className="col-lg-4 col-md-4 col-4">
            {t("کد طرف حساب")}:10102012
          </div>
          <div className="col-lg-4 col-md-4 col-4">
            {t("نام طرف حساب")}:خشایار امیری
          </div>
          <div className="col-lg-4 col-md-4 col-4">
            {t("ویزیتور")}:فاطمه کمری
          </div>
          <div className="col-lg-4 col-md-4 col-4">
            {t("دلیل برگشتی")}:عودت توسط مشتری
          </div>
