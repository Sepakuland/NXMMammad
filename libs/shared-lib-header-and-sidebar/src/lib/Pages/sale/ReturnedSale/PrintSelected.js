    ...
    return (
        <td  className={'td-p0 border-left-0'} style={{height:'72px',overflow:'visible'}}>
            <div>
                ...
                <div className={`empty-footer-border  ${i18n.dir()} justify-content-end nowrap`}>{t('تخفیف حجمی(0%)')}</div>
                <div className={`empty-footer  ${i18n.dir()} justify-content-end nowrap`}>{t(' مبلغ نهایی فاکتور:')}</div>
            </div>
        </td>
  ...
  return (
      <td  className={'td-p0 border-left-0'} style={{height:'72px',overflow:'visible'}}>
          <div>
              ...
              <div className={`empty-footer-border ${i18n.dir()} justify-content-end word-break`}>{'0 تومان'.toLocaleString()}</div>
              <div className={`empty-footer ${i18n.dir()} justify-content-end word-break`}>{'300000000 تومان'.toLocaleString()}</div>
          </div>
      </td>
