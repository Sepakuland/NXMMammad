...
import { useCreateAccountingDocumentMutation, useGetAccountingDocumentFormDataQuery, useGetNextDocumentNumbersQuery } from '../../../features/slices/accountingDocumentSlice';
...
export default function KaraDataGrid() {
    ...
    const { data: branchList = [{ branchId: 0 }], isFetching: branchlistIsFetching, error: branchListError, refetch: branchRefetch } = useFetchBranchesQuery("",
        {
    ...
    useEffect(() => {
        if (id !== null && !accountingDocumentIsFetching && !accountingDocumentError && branchDatasource.length > 0) {
            let copyValues = JSON.parse(JSON.stringify(accountingDocumentRes))
            let branch = branchDatasource.find(a => a.branchId == accountingDocumentRes.branchId)
            ...
            copyValues.documentDate = julianIntToDateTime(new DateObject().toJulianDay())
            formik.setValues(copyValues)
                .then(() => {
    ...
    const { data: documentDefinitionList = { documentTypeId: 0 }, isFetching: documentDefinitionlistIsFetching, error: documentDefinitionListError } = useGetAllDocumentDefinitionQuery()
    useEffect(() => {
    ...
    const formik = useFormik({
        ...
        validationSchema: Yup.object({
            ...
            documentDescription: Yup.string()
                .required("وارد کردن شرح سند الزامی است"),
            ...
            balance: Yup.number().test(
                'isZero', 'سند حسابداری غیرتراز نمی‌تواند در سیستم ثبت شود',
                (item, testContext) => {
                    if (item === 0) {
                        return true
                    }
        ...
        onSubmit: (values) => {
            var documentArticles = JSON.parse(JSON.stringify(values.documentArticles))
            ...
            createDocument({ ...values, isDraft: false }).unwrap()
                .then(() => {
                    NavigateToGrid();
                })
                .catch((error) => {
    ...
    function handleDraftSubmit() {
        var documentArticles = JSON.parse(JSON.stringify(formik.values.documentArticles))
        ...
        createDocument({ ...formik.values, isDraft: true }).unwrap()
            .then(() => {
                NavigateToGrid();
            })
            .catch((error) => {
    ...
    return (
        <>
                                ...
                                <form onSubmit={formik.handleSubmit}>
                                    <div className='form-design'>
                                        <div className='row row-8'>
                                            ...
                                            <div className='content col-lg-custom-8 col-md-6 col-12' onFocus={() => {
                                            ...
                                            <div className='content col-lg-custom-8 col-md-6 col-12'>
                                                ...
                                                <div className='wrapper'>
                                                    ...
                                                    {formik.touched.documentDate && formik.errors.documentDate && !formik.values.documentDate ? (
                                                        <div
                                                            className='error-msg'>{t(formik.errors.documentDate)}</div>) : null}
                                                </div>
                                            </div>
                                            <div className="content col-lg-custom-8 col-md-6 col-12" onFocus={() => {
                                                dateRef?.current?.closeCalendar()
                                                ...
                                                <div className='wrapper'>
                                                    <div>
                                                        <SelectBox
                                                            ...
                                                            onValueChanged={(e) => formik.setFieldValue('documentTypeId', e.value)}
                                                    ...
                                                    {formik.touched.documentTypeId && formik.errors.documentTypeId ? (<div
                                            ...
                                            <div className="content col-lg-custom-8 col-md-6 col-12">
                                                ...
                                                <div className='wrapper'>
                                                    <div>
                                                        <SelectBox
                                                            ...
                                                            onValueChanged={(e) => {
                                                                ...
                                                                formik.setFieldValue('folioNumber', branch.folioNumber + branch.nextFolioNumber - 1)
                                                            }}
                                                            className='selectBox'
                                                            noDataText={t("اطلاعات یافت نشد")}
                                                    ...
                                                    {formik.touched.branchId && formik.errors.branchId ? (<div
            ...
            <div>
                <div className={`button-pos mt-0 ${i18n.dir() === 'ltr' ? 'ltr' : 'rtl'}`}>
                    <Button
                        variant="contained"
                        color="success"
                        type="button"
