...
const MoeinLostBenefitPrint = () => {
    console.log("yohahahahahaha   >)")
            ...
            if (item.operationalStatus === operationalStatus) {
                ...
                if (item?.totalCodingNature == 1) {
                    if (result[item.name]) {
                        ...
                        result[item.name].debits += item.debits.reduce((acc, current) => acc + current, 0);
                    } else {
                        // If the name doesn't exist, create a new object
                        result[item.name] = {
                            parentName: item?.codingParent.name,
                            name: item.name,
                    ...
                    if (result[item.name]) {
                        // If the name already exists in the result, update the values
                        result[item.name].credits += item.credits.reduce((acc, current) => acc + current, 0);
    ...
    return (
        <>
                ...
                <div>
                    ...
                    <div className="top">
                        {OperatingRevenues?.map((item, index) => {
                            return (
                                <section className='moein-lostBenefit'>
                                    <>

                                        <div className={`${index % 2 != 0 ? "border-none" : ""}`}>
                                            <section>{item?.parentName}</section>
                                        </div>
                                        <div className={`${index % 2 != 0 ? "border-none" : ""}`}>
                    ...
                    <div className="top">
                        {NonOperatingRevenues?.map((item, index) => {
                            return (
                                <section className='moein-lostBenefit'>
                                    <>
                                        <div className={`${index % 2 != 0 ? "border-none" : ""}`}>
                    ...
                    <div className="top">
                        {NonOperatingExpenses?.map((item, index) => {
                            return (
                                <section className='moein-lostBenefit'>
                                    <>
                                        <div className={`${index % 2 != 0 ? "border-none" : ""}`}>
                    ...
                    {/* OtherNonOperating */}
                    <div className="top">
                        {OtherNonOperating?.map((item, index) => {
                            return (
                                <section className='moein-lostBenefit'>
                                    <>
                                        <div className={`${index % 2 != 0 ? "border-none" : ""}`}>
            ...
            <div className="LostBenefitFooter row" style={{ marginTop: "596px" }}>
...
export default MoeinLostBenefitPrint;  