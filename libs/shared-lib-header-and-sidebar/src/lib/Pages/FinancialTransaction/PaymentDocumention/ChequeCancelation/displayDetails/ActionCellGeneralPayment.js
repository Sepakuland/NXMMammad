...
const ActionCellMainCheque = (props) => {
  ...
  const PrintSelected = () => {
    window.open(
      `/FinancialTransaction/PaymentDocument/general/displayDetails/PrintSelected?id=${props.dataItem.DocumentCode}`,
      "_blank",
      "noopener,noreferrer"
    );
  };
        ...
        <div className={`d-flex justify-content-evenly`}>
          <Tooltip title={t("ویرایش")}>
            <IconButton
              ...
              onClick={() => console.log("edit", props.dataItem.BankAccountCode)}
            >
              <EditIcon />
            </IconButton>
          </Tooltip>
