                                                                                        ...
                                                                                        >
                                                                                            ...
                                                                                            <td style={{width:'40px'}}>
                                                                                                <IconButton variant="contained" color="error" className='kendo-action-btn' onClick={() => {
                                                                                                    ...
                                                                                                    let temp = articlesTouch.filter((_, i) => i !== index)
            ...
            <div>
                <div className={`button-pos ${i18n.dir()=='ltr'?'ltr':'rtl'}`}>
                    ...
                    <div className="Issuance">
                        <Button variant="contained" color="error" onClick={() => { history.navigate(`/FinancialTransaction/PaymentDocument/Cash/Display`, 'noopener,noreferrer'); } }>
                            {t("انصراف")}
                        </Button>
                    </div>
                </div>
