...
const ActionCellMainCheque = (props) => {
    ...
    const PrintSelected = () => {
        window.open(`/FinancialTransaction/PaymentDocument/RemittancePayable/DisplayDetails/PrintSelected?id=${props.dataItem.DocumentCode}`, '_blank');
    }
    const EditMultiPlexing = () => {
        ...
        history.navigate(`/FinancialTransaction/receiptDocument/remittanceReceivable/displayDetails/EditMultiPlexing?id=1805`)
    }
    return (
        <>
            <td colSpan="1" >
