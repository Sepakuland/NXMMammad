...
const ActionCell = (props) => {
    ...
    const Edit = () => {
        navigate(`/FinancialTransaction/ReceiptDocument/General/Issuance?id=${props.dataItem.DocumentId}`, { replace: false });
    }

    const Print = () => {
        window.open(`/FinancialTransaction/ReceiptDocument/General/DisplayDetails/PrintReceiptRow?id=${props.dataItem.DocumentCode}&lang=${i18n.language}`, '_blank', 'noopener,noreferrer');
    }
    return (
        <>
            <td colSpan="1" >
