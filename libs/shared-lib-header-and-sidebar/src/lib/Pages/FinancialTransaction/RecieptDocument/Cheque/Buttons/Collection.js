...
import { BankData, cashDatagridCashLookup, ChequeSerialLookUp } from './bankdata.js';
import AddIcon from '@mui/icons-material/Add';
import { Autocomplete, Box, Button, FormControlLabel, IconButton, Radio, RadioGroup, TextField } from '@mui/material';
...
const Collection = () => {
    ...
    const emptyCheque = { formikId: new Guid().valueOf(), serial: "", BackNumber: "", maturity: "", bankCode: "", bankName: "", amount: "", partnerCode: "", partnerName: "", legalName: "", description: "" }
    ...
    const formik = useFormik({
        ...
        validationSchema: Yup.object({
            date: Yup.date()
                .required("وارد کردن تاریخ سند الزامی است"),
            paidTo: Yup.string(),
            cash: Yup.string().when("paidTo", (paidTo) => {
                if (paidTo === "cash")
                    return Yup.string().required('صندوق الزامی است')
            }),
            accountNumber: Yup.string().when("paidTo", (paidTo) => {
                if (paidTo === "accountNumber")
                    return Yup.string().required('شماره حساب الزامی است')
            }),
    ...
    function CallCancellComponent() {
        history.navigate(`/FinancialTransaction/receiptDocument/Cheque/DisplayDetails`);
    }
    const callComponent = () => {
        window.open(`/FinancialTransaction/receiptDocument/Cheque/ExportToPDFPageC?lang=${i18n.language}`, '_blank');
    }
    ////////////////////////////////////
    ...
    function serialKeyDownHandler(e) {
        ...
        if (e.keyCode === 40 && serialOpen === false) { /* Down Arrowkey */
            e.preventDefault()
        ...
        if (e.keyCode === 38 && serialOpen === false) { /* Up ArrowKey */
            e.preventDefault()
        ...
        if (e.keyCode === 13 && serialOpen === false) { /* Enter */
    ...
    useEffect(() => {
        if (formik.values?.chequeReceived?.length) {
            let temp = formik.values.chequeReceived?.filter((item) => item.serial != '')
        ...
        <>
            <div className='form-template' style={{
                ...
                <div>
                            ...
                            <div className='form-design'>
                                <div className='row'>
                                        ...
                                        <div className='wrapper' >
                                            <div className='date-picker position-relative'>
                                                ...
                                                <div className={`modal-action-button  ${i18n.dir() === "ltr" ? 'action-ltr' : ''}`}>
                                                    <div className='d-flex align-items-center justify-content-center'><CalendarMonthIcon className='calendarButton modal' /></div>
                                                </div>
                                            </div>
                                    ...
                                    <div className="content col-lg-12 col-md-12 col-12">
                                        <div className="title">
                                            <span>{t("واریز به")}</span>
                                        </div>
                                        <div className="wrapper">
                                            <RadioGroup
                                                name="pie-field"
                                                //defaultChecked="accountSideCheque"
                                                defaultValue={formik.values.paidTo}
                                    ...
                                    {formik.values.paidTo === "accountNumber" && (
                                        <>
                                            <div className='content col-lg-4 col-md-4 col-12'>
                                                <div className='title'>
                                                ...
                                                <div className='wrapper'>
                                                    <div>
                                                        <SelectBox
                                                            ...
                                                            onValueChanged={(e) => formik.setFieldValue('accountNumber', e.value)}
                                                            className='selectBox'
                                        ...
                                        <>
                                            <div className='content col-lg-4 col-md-4 col-12'>
                                                ...
                                                <div className='wrapper'>
                                                    <div>
                                                        <SelectBox
                                                            dataSource={cashDatagridCashLookup}
                                                            rtlEnabled={i18n.dir() === "ltr" ? false : true}
                                                            onValueChanged={(e) => formik.setFieldValue('cash', e.value)}
                                                            className='selectBox'
                                                            noDataText={t("اطلاعات یافت نشد")}
                                                            itemRender={null}
                                                            placeholder=''
                                            ...
                                            <div className='content col-lg-12 col-12'>
                                                    ...
                                                    <table className="table table-bordered">
                                                        ...
                                                        <tbody>
                                                            <FieldArray
                                                                ...
                                                                render={({ push, remove }) => (
                                                                    <React.Fragment>
                                                                        {formik?.values?.chequeReceived?.map((chequeReceives, index) => (
                                                                            <tr key={chequeReceives.formikId} onFocus={(e) => setChequeFocusedRow(e.target.closest("tr").rowIndex)}
                                                                                        ...
                                                                                        <Autocomplete
                                                                                            ...
                                                                                            renderOption={(props, option) => (
                                                                                                <Box component="li" {...props}>
                                                                                                    {option.ChequeCode} - {option.BackNumber} - {option.PartnerName} -{option.MaturityDate} -{option.BankName} - {option.InputPrice}
                                                                                                </Box>
                                                                                            )}
                                                                                            filterOptions={(options, state) => {
                                                                                                ...
                                                                                                options.forEach((element) => {
                                                                                                    if (
                                                                                                        element.ChequeCode.includes(state.inputValue.toLowerCase()) ||
                                                                                                        element.BackNumber.includes(state.inputValue.toLowerCase()) ||
                                                                                                        element.PartnerName.replace("/", "").toLowerCase().includes(state.inputValue.toLowerCase()) ||
                                                                                                        element.BankName.replace("/", "").toLowerCase().includes(state.inputValue.toLowerCase())
                                                                                                    )
                                                                                                        newOptions.push(element);
                                                                                                });
                                                                                                return newOptions;
                                                                                            }}
                                                                                            getOptionLabel={option => option.ChequeCode}
                                                                                            componentsProps={{
                                                                                                paper: {
                                                                                                    sx: {
                                                                                                        width: 150,
                                                                                            ...
                                                                                            open={chequeFocusedRow === index + 1 ? serialOpen : false}
                                                                                            noOptionsText={t("اطلاعات یافت نشد")}
                                                                                            onInputChange={(event, value) => {
                                                                                                if (value !== "" && event !== null) {

                                                                                                    RenderSerialOpenState(index, true)
                                                                                                }
                                                                                                else {
                                                                                                    RenderSerialOpenState(index, false)
                                                                                                }
                                                                                            }}
                                                                                            onChange={(event, value) => {
                                                                                                RenderSerialOpenState(index, false)
                                                                                                formik.setFieldValue(`chequeReceived[${index}].serial`, value.ChequeCode)
                                                                                                formik.setFieldValue(`chequeReceived[${index}].BackNumber`, value.BackNumber)
                                                                                                formik.setFieldValue(`chequeReceived[${index}].maturity`, value.MaturityDate)
                                                                                                formik.setFieldValue(`chequeReceived[${index}].bankCode`, value.BankCode)
                                                                                                formik.setFieldValue(`chequeReceived[${index}].bankName`, value.BankName)
                                                                                                formik.setFieldValue(`chequeReceived[${index}].amount`, value.InputPrice)
                                                                                                formik.setFieldValue(`chequeReceived[${index}].partnerCode`, value.PartnerCode)
                                                                                                formik.setFieldValue(`chequeReceived[${index}].partnerName`, value.PartnerName)
                                                                                                formik.setFieldValue(`chequeReceived[${index}].legalName`, value.PartnerLegalName)
                                                                                                formik.setFieldValue(`chequeReceived[${index}].description`, value.DocumentDescription)
                                                                                            }}
                                                                                            onBlur={(e) => RenderSerialOpenState(index, false)}
                                                                                            renderInput={params => (
                                                                                                <TextField {...params} label="" variant="outlined" />
                                                                                            )}
                                                                                            onKeyDown={(e) => {
                                                                                                if ((e.keyCode === 13 || e.keyCode === 9 || e.keyCode === 38 || e.keyCode === 40 || e.keyCode === 37 || e.keyCode === 39) && serialOpen[index] === false) {
                                                                                                    e.preventDefault()
                                                                                                    RenderSerialOpenState(index, false)
                                                                                                }
                                                                                ...
                                                                                <td style={{ minWidth: '120px' }}>
                                                                                    <input
                                                                                        ...
                                                                                        value={formik.values.chequeReceived[index].BackNumber}
                                                                                        autoComplete="off"
                                                                                        disabled
                                                                                    />
                                                                                </td>
                                                                                <td style={{ minWidth: '120px' }}>
                                                                                    <input
                                                                                        ...
                                                                                        type='text'
                                                                                        onChange={formik.handleChange}
                                                                                        value={formik.values.chequeReceived[index].maturity}
                                                                                        autoComplete="off"
                                                                                        disabled
                                                                                    />
                                                                                </td>
                                                                                <td style={{ minWidth: '120px' }}>
                                                                                    <input
                                                                                        ...
                                                                                        type='text'
                                                                                        onChange={formik.handleChange}
                                                                                        value={formik.values.chequeReceived[index].bankCode}
                                                                                        autoComplete="off"
                                                                                        disabled
                                                                                    />
                                                                                </td>
                                                                                <td style={{ minWidth: '120px' }}>
                                                                                    <input
                                                                                        ...
                                                                                        type='text'
                                                                                        onChange={formik.handleChange}
                                                                                        value={formik.values.chequeReceived[index].bankName}
                                                                                        autoComplete="off"
                                                                                        disabled
                                                                                    />
                                                                                </td>
                                                                                <td style={{ width: '120px', minWidth: '90px' }}>
                                                                                    <CurrencyInput
                                                                                        ...
                                                                                        value={formik.values.chequeReceived[index].amount}
                                                                                        decimalsLimit={2}
                                                                                ...
                                                                                <td style={{ minWidth: '120px' }}>
                                                                                    <input
                                                                                        ...
                                                                                        type='text'
                                                                                        onChange={formik.handleChange}
                                                                                        value={formik.values.chequeReceived[index].partnerCode}
                                                                                        autoComplete="off"
                                                                                        disabled
                                                                                    />
                                                                                </td>
                                                                                <td style={{ minWidth: '120px' }}>
                                                                                    <input
                                                                                        ...
                                                                                        type='text'
                                                                                        onChange={formik.handleChange}
                                                                                        value={formik.values.chequeReceived[index].partnerName}
                                                                                        autoComplete="off"
                                                                                        disabled
                                                                                    />
                                                                                </td>
                                                                                <td style={{ minWidth: '120px' }}>
                                                                                    <input
                                                                                        ...
                                                                                        type='text'
                                                                                        onChange={formik.handleChange}
                                                                                        value={formik.values.chequeReceived[index].legalName}
                                                                                        autoComplete="off"
                                                                                        disabled
                                                                                    />
                                                                                </td>
                                                                                <td style={{ minWidth: '120px' }}>
                                                                                    <input
                                                                                        ...
                                                                                        type='text'
                                                                                        onChange={formik.handleChange}
                                                                                        value={formik.values.chequeReceived[index].description}
                                                                                        autoComplete="off"
                                                                                        disabled
                                                                                    />
                                                                                </td>
                                                ...
                                                {formik?.errors?.chequeReceived?.map((error, index) => (
                                                    <p className='error-msg' key={index}>
                                                        {error ? ` ${t("ردیف")} ${index + 1} : ${error?.serial ? t(error.serial) : ""}` : null}
                                                    </p>
                                                ))}
                                            </div>
                                        </div>
                    ...
                    <div className="button-export col-12 justify-content-end d-flex" style={{ paddingLeft: " 20px", paddingRight: "20px" }}>
                                ...
                                <table className="table table-bordered" ref={tableRef}>
                                    ...
                                    <tbody>
                                        {excelData?.map((chequeReceives, index) => (
                                            <tr key={index} onFocus={(e) => setChequeFocusedRow(e.target.closest("tr").rowIndex)}
                                                className={chequeFocusedRow === index + 1 ? 'focus-row-bg' : ''} >
                                                <td className='text-center' style={{ verticalAlign: 'middle', width: '30px' }}>
                                                    {index + 1}
                                                </td>
                                                <td >
                                                    {chequeReceives.serial}
                                                </td>
                                                <td >
                                                    {chequeReceives.BackNumber}
                                                </td>
                                                <td >
                                                    {getLangDate(i18n.language, chequeReceives.maturity)}
                                                </td>
                                                <td >
                                                    {chequeReceives.bankCode}
                                                </td>
                                                <td >
                                                    {chequeReceives.bankName}
                                                </td>
                                                <td >
                                                    {chequeReceives.amount}
                                                </td>
                                                <td >
                                                    {chequeReceives.partnerCode}
                                                </td>
                                                <td >
                                                    {chequeReceives.partnerName}
                                                </td>
                                                <td >
                                                    {chequeReceives.legalName}
                                                </td>
                                                <td >
                                                    {chequeReceives.description}
                                                </td>
