...
const Issuance = () => {
    ...
    const formik = useFormik({
        ...
        initialValues: {
            BehindScore: Math.floor(Math.random() * 1000),
        ...
        validationSchema: Yup.object({
            ...
            BranchCode: Yup.number().typeError("تنها عدد مجاز است"),
            ChequeNumber: Yup.number().typeError("تنها عدد مجاز است").required("انتخاب شماره چک الزامیست"),
            AccountNumber: Yup.number().typeError("تنها عدد مجاز است").required("انتخاب شماره حساب الزامیست"),
            DueDate: Yup.date().required("وارد کردن تاریخ الزامی است"),
            BranchName: Yup.string()
                .required("انتخاب نام شعبه الزامیست"),
        }),
        onSubmit: (values) => {
    ...
    function getData(data) {
        ...
        formik.setFieldValue('AccountReconciliation', data)
    }
    return (
        <>
                    ...
                    <form onSubmit={formik.handleSubmit}>
                        <div className="form-design">
                            <div className="row">
                                    ...
                                    <div className="wrapper">
                                        <div>
                                            <input
                                                ...
                                                value={formik.values.BehindScore}
                                                disabled
                                            />
                                        </div>
                                ...
                                <div className="content col-lg-6 col-md-6 col-12">
                                    <div className="title">
                                        <span>{t("نام شعبه")}<span className="star">*</span></span>
                                    </div>
                                    <div className="wrapper">
                                        <div>
                                            <input
                                    ...
                                    <div className="wrapper">
                                        <div>
                                            <input
                                                ...
                                                onChange={formik.handleChange}
                                                onBlur={formik.handleBlur}
                                                value={formik.values.CityOfIssue}
                                            />
                                            {formik.touched.CityOfIssue && formik.errors.CityOfIssue ? (
                                                <div className='error-msg'>
                                                    {t(formik.errors.CityOfIssue)}
                                                </div>
                                            ) : null}
                                        </div>
                                    </div>
                                ...
                                <div className="content col-lg-6 col-md-6 col-12">
                                    <div className="title">
                                        <span>{t("شماره چک")}<span className="star">*</span></span>
                                    </div>
                                    <div className="wrapper">
                                        <div>
                                            <input
                                ...
                                <div className="content col-lg-6 col-md-6 col-12">
                                    <div className="title">
                                        <span>{t("شماره حساب")}<span className="star">*</span></span>
                                    </div>
                                    <div className="wrapper">
                                        <div>
                                            <input
                                ...
                                <div className="content col-lg-6 col-md-6 col-12">
                                    <div className="title">
                                        <span>{t("تاریخ سررسید")}<span className="star">*</span></span>
                                    </div>
                                    <div className="wrapper date-picker position-relative">
                                        <DatePicker
                                            name={"DueDate"}
