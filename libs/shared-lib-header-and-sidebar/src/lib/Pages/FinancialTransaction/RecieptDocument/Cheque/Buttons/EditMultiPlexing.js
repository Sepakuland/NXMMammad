import { DataGrid, Toast, TreeView } from 'devextreme-react';
import React, { useEffect, useRef, useState } from 'react'
import Guid from 'devextreme/core/guid';
import { Autocomplete, Box, Button, Dialog, DialogContent, IconButton, makeStyles, Paper, TextField, useTheme } from '@mui/material';
            ...
            <div>
                <div className={`button-pos ${i18n.dir == 'ltr' ? 'ltr' : 'rtl'}`}>
                    ...
                    <div className="Issuance">
                        <Button variant="contained" color="error" onClick={() => { history.navigate(`/FinancialTransaction/receiptDocument/Cheque/DisplayDetails`, 'noopener,noreferrer'); }}>
                            {t("انصراف")}
                        </Button>
                    </div>
                </div>
