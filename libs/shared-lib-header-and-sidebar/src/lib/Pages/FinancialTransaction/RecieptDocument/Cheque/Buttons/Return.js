...
import { ChequeSerialLookUp } from './bankdata.js';
...
const Return = () => {
    ...
    function CallCancellComponent() {
        history.navigate(`/FinancialTransaction/receiptDocument/Cheque/DisplayDetails`, 'noopener,noreferrer');
    }
    const callComponent = () => {
        window.open(`/FinancialTransaction/receiptDocument/Cheque/ExportToPDFPageR?lang=${i18n.language}`, '_blank', 'noopener,noreferrer');
    }
    ////////////////////////////////////
