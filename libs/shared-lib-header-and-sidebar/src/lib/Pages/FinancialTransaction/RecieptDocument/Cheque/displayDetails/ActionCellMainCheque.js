...
const ActionCellMainCheque = (props) => {
    ...
    const PrintSelected = () => {
        window.open(`/FinancialTransaction/receiptDocument/Cheque/displayDetails/PrintSelected?id=${props.dataItem.DocumentCode}`, '_blank');
    }
    const EditMultiPlexing = () => {
        ...
        history.navigate(`/FinancialTransaction/receiptDocument/Cheque/EditMultiPlexing?id=1805`)
    }
    return (
        <>
            <td colSpan="1" >
