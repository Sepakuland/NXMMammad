...
const DashboardDefault = () => {
  ...
  return (
    ...
    //         <AnalyticEcommerce title={t('Total Page Views')} count="4,42,236" percentage={59.3} extra="35,000" />
    //     </Grid>
    //     <Grid item xs={12} sm={6} md={6} lg={3}>
    //         <AnalyticEcommerce title={t('Total Users')} count="78,250" percentage={70.5} extra="8,900" />
    //     </Grid>
    //     <Grid item xs={12} sm={6} md={6} lg={3}>
    //         <AnalyticEcommerce title={t("Total Order")} count="18,800" percentage={27.4} isLoss color="warning" extra="1,943" />
    //     </Grid>
    //     <Grid item xs={12} sm={6} md={6} lg={3}>
    //         <AnalyticEcommerce title={t("Total Sales")} count="$35,078" percentage={27.4} isLoss color="warning" extra="$20,395" />
    //     </Grid>
    ...
    //                     <Typography variant="h5">{t('Low')}</Typography>
    //                 </ListItemButton>
    //             </List>
    //             <ReportAreaChart />
    //         </MainCard>
