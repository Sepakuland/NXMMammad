...
const ActionCell = (props) => {
    ...
    function Installment_CountInstalled() {
        console.log("settled")
    }
        ...
        <>
            <td colSpan="1" >
                <div className={`d-flex justify-content-between`} >
                    <Tooltip title={t("تسویه اقساط باقیمانده")}>
                        <IconButton variant="contained" color='info' className='kendo-action-btn' onClick={() => Installment_CountInstalled()}>
                            <FactCheckIcon />
                        </IconButton >
                    </Tooltip>
