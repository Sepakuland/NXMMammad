...
const ActionCell = (props) => {
  ...
  const PrintSelectedWC = () => {
    window.open(
      `/buy/returnedPurchase/PrintSelectedWC?id=${props.dataItem.DocumentCode}`,
      "_blank",
    );
  };
  const PrintSelectedWOC = () => {
    window.open(
      `/buy/returnedPurchase/PrintSelectedWOC`,
      "_blank",
    );
  };
  const PrintSelected = () => {
    window.open(
      `/buy/returnedPurchase/PrintSelected?id=${props.dataItem.OrderCode}`,
      "_blank"
    );
  };
