...
export default function ReceiptDocument() {
  ...
  useEffect(() => {
    if (purchaseBrokenDiscountTotal) {
      if (
        purchaseBrokenDiscountTotal[purchaseBrokenDiscountTotal.length - 1] !==
        "."
      ) {
        formik.setFieldValue(
          ...
          parseFloat(
            ((parsFloatFunction(
              purchaseBrokenDiscountTotal.toString()?.replaceAll(",", ""),
              2
            ) || 0) /
              (purchasePriceTotal - purchaseDiscountAmountTotal || 1)) *
              100,
            2
          )
        );
        formik.values.purchaseReceived.forEach((item, index) => {
          ...
          console.log(
            ...
            (parseInt(tempPrice) || 0) -
              ((parseInt(tempPrice) * parseInt(item.discountPercentage)) /
                100 || 0) -
              (parseInt(purchaseBrokenDiscountTotal) || 0)
          );
          ...
          formik.setFieldValue(
            `purchaseReceived[${index}].brokenDiscount`,
            parseInt(purchaseBrokenDiscountTotal)
          );
          formik.setFieldValue(
            `purchaseReceived[${index}].sum`,
            (parseInt(tempPrice) || 0) -
            ((parseInt(tempPrice) * parseInt(item.discountPercentage)) /
              100 || 0) -
            (parseInt(purchaseBrokenDiscountTotal) || 0) + formik.values.purchaseReceived[index].amountAddedTax || 0
          );
  ...
  }, [formik.values.purchaseReceived, purchaseBrokenDiscountTotal]);
                  ...
                  <div className="row">
                    ...
                    <div className="content col-lg-3 col-12">
                      ...
                      <input
                        ...
                        value={parseFloat(
                          formik.values.discountBrokenPercentage,
                          2
                        )}
                        onBlur={formik.handleBlur}
                        onChange={(e) => {
