...
import { definedAccountLookupData, descriptiveLookupData } from "../New Document/lookupData";
                                    ...
                                    <div className="wrapper">
                                        <div>
                                            <Autocomplete
                                                ...
                                                onChange={(event, value) => {
                                                    setDescriptiveOpen(false)
                                                    formik.setFieldValue("descriptive", value.Code)
                                                }}
                                                onBlur={(e) => setDescriptiveOpen(false)}
                                                renderInput={params => (
                                                    <TextField {...params} label="" variant="outlined" />
                                                )}
                                            />
