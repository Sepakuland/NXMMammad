...
import { useGetAccountingDocumentRecyclebinsPrintQuery } from "../../../../../features/slices/accountingDocumentRecycleBinSlice";

const DocumentTrashPrint = () => {
  ...
  } = useGetAccountingDocumentRecyclebinsPrintQuery(
    CreateQueryString({ DocumentRecycleBinId: obj.id.split(",") })
  );
...
export default DocumentTrashPrint;
