...
import {UpdateCodingModal} from '@kara-erp/shared-lib-header-and-sidebar';
import {CreateCodingModal} from '@kara-erp/shared-lib-header-and-sidebar';
import DoneIcon from '@mui/icons-material/Done';
import CloseIcon from '@mui/icons-material/Close';
import trashIcon3 from '../../../assets/images/icons/trash-icon3.gif';
import { LoadingButton, TabContext, TabList, TabPanel } from '@mui/lab';
import SettingsIcon from '@mui/icons-material/Settings';
import {CodingSettings} from '@kara-erp/shared-lib-header-and-sidebar';
import * as Yup from 'yup';
import { useAddAutoCodingMutation, useDeleteCodingMutation, useFetchCodingsQuery, useUpdateCodingDetailedMatchMutation } from '@kara-erp/shared-lib-header-and-sidebar';
import { useFetchDetailedTypesQuery } from '@kara-erp/shared-lib-header-and-sidebar';
import {MergeCodingModal} from '@kara-erp/shared-lib-header-and-sidebar';
...
const Coding = () => {
    ...
    useEffect(() => {
        ...
        //     console.log()
        // }
        if (updateResults.isError && updateResults.status !== "fulfilled" && !updateResults.isSuccess) {
